...
def test_in_daily_watch_window_0705_to_0759():
    assert in_daily_watch_window(datetime(2026, 3, 11, 7, 5, tzinfo=THAI_TZ))
    assert in_daily_watch_window(datetime(2026, 3, 11, 7, 30, tzinfo=THAI_TZ))
    assert in_daily_watch_window(datetime(2026, 3, 11, 7, 59, tzinfo=THAI_TZ))
    assert not in_daily_watch_window(datetime(2026, 3, 11, 7, 4, tzinfo=THAI_TZ))
    assert not in_daily_watch_window(datetime(2026, 3, 11, 8, 0, tzinfo=THAI_TZ))