...
from kalshi_engine.candle_pattern import detect_candle_patterns
from kalshi_engine.fibonacci_confluence import build_fib_levels_from_swing, find_confluence_zones
from kalshi_engine.future_projection import project_next_wave
from kalshi_engine.inprogress_detector import detect_inprogress_wave
from kalshi_engine.key_levels import align_corrective_key_levels_to_bias, extract_pattern_key_levels
from kalshi_engine.multi_count_engine import (
...
from kalshi_engine.wave_decision_engine import build_wave_summary
from kalshi_engine.wave_position import detect_wave_position
from kalshi_engine.wave_sequence_engine import build_wave_sequence
...
from kalshi_engine.report_formatter import format_report
from kalshi_engine.scenario_engine import generate_scenarios, prioritize_scenarios
...
def build_dataframe_analysis(
    ...
    if _price is not None:
        ...
        if _inverted:
            from kalshi_engine.key_levels import KeyLevels
            _new_sup = None
            _new_res = None
            _new_inv = None
    ...
    from kalshi_engine.scenario_engine import generate_inprogress_scenarios as _gen_inprog
